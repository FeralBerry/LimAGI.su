...
For full documentation and examples, please visit [Bootstrap Date Paginator Website](https://www.jondmiles.com/bootstrap-datepaginator/ "Click to visit Bootstrap Date Paginator")

## Requirements

- [Bootstrap v3.0.3](https://getbootstrap.com/)
- [jQuery v2.0.3](https://jquery.com/)
- [Moment.js v2.4.0](https://momentjs.com)
