<div data-widget-group="group1">
    <div class="panel panel-default" data-widget='{"draggable": "false"}'>
        ...
        <div class="panel-body">
            <form action="{{ route('admin-pay-courses-add') }}" class="form-horizontal row-border" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="access_id" class="form-control" placeholder="Группа курса" value="">
                    </div>
                </div>
                <div class="col-xs-12">
