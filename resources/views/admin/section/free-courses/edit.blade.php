    ...
    <div class="panel panel-default" data-widget='{"draggable": "false"}'>
        ...
        <div class="panel-body">
            @foreach($courses as $item)
                <form action="{{ route('admin-free-courses-edit', $item->id ) }}" class="form-horizontal row-border" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <a href="{{ route('admin-free-courses-video-delete', $item->id) }}"><i class="fa fa-close" style="color: red; font-size: 50px"></i></a><br>@endif
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Ссылка для скачивания материалов</label>
                        <div class="col-sm-8">
                            <input type="text" name="materials" class="form-control" placeholder="Ссылка для скачивания материалов" value="{{ $item->link_materials }}">
                        </div>
                    </div>
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                ...
                                <a href="{{ route('admin-free-courses-delete', $item->id) }}"><button class="btn-danger btn">Удалить</button></a>
                            </div>
                        </div>
                    </div>
                </form>
