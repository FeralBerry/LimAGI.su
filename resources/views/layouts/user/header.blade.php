    ...
    <ul class="nav navbar-nav toolbar pull-right">
        ...
        <li class="dropdown toolbar-icon-bg">
            ...
            <ul class="dropdown-menu userinfo arrow">
                <li><a href="#"><span class="pull-left">Профиль</span> {{--<span class="badge badge-info">80%</span><--}}</a></li>
                {{--<li><a href="#"><span class="pull-left">Account</span> <i class="pull-right fa fa-user"></i></a></li>--}}
                <li><a href="{{ route('user-info') }}"><span class="pull-left">Настройки</span> <i class="pull-right fa fa-cog"></i></a></li>
