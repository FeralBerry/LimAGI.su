<div class="demo-options">
    ...
    <div class="demo-heading">Визуальные настройки</div>
    <div class="demo-body">
        <div class="tabular">
            <div class="tabular-row">
                <div class="tabular-cell">Фиксированая шапка</div>
            ...
            <div class="tabular-row">
                <div class="tabular-cell">Растянутость</div>
            ...
            <div class="tabular-row">
                <div class="tabular-cell">Левое меню</div>
            ...
            {{--<div class="tabular-row" id="demo-horizicon">
    ...
    <div class="demo-body">
        <div class="option-title">Цвет шапки</div>
    ...
    <div class="demo-body">
        <div class="option-title">Цвет меню</div>
    ...
    {{--<div class="demo-body" id="demo-boxes">
