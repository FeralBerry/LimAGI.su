                        ...
                        <div class="yamm-content container-sm-height">
                            <div class="row row-sm-height yamm-col-bordered">
                                ...
                                <div class="col-sm-3 col-sm-height yamm-col">
                                    ...
                                    <img src="https://placehold.it/300&text=Placeholder" class="mb20 img-responsive" style="width: 100%;">
    ...
    <ul class="nav navbar-nav toolbar pull-right">
            ...
            <div class="dropdown-menu dropdown-alternate messages arrow">
                ...
                <div class="scrollthis scroll-pane">
                    <ul class="scroll-content">
                        <li class="">
                            <a href="#">
                                <img class="msg-avatar" src="{{ asset('admin/demo/avatar/avatar_09.png') }}" alt="avatar" />
                        ...
                        <li>
                            <a href="#">
                                <img class="msg-avatar" src="{{ asset('admin/demo/avatar/avatar_01.png') }}" alt="avatar" />
                                <div class="msg-content">
                        ...
                        <li>
                            <a href="#">
                                <img class="msg-avatar" src="{{ asset('admin/demo/avatar/avatar_05.png') }}" alt="avatar" />
                                <div class="msg-content">
                        ...
                        <li>
                            <a href="#">
                                <img class="msg-avatar" src="{{ asset('admin/demo/avatar/avatar_02.png') }}" alt="avatar" />
                                <div class="msg-content">
                        ...
                        <li>
                            <a href="#">
                                <img class="msg-avatar" src="{{ asset('admin/demo/avatar/avatar_03.png') }}" alt="avatar" />
                                <div class="msg-content">
                        ...
                        <li>
                            <a href="#">
                                <img class="msg-avatar" src="{{ asset('admin/demo/avatar/avatar_07.png') }}" alt="avatar" />
                                <div class="msg-content">
        ...
        <li class="dropdown toolbar-icon-bg">
            ...
            <ul class="dropdown-menu userinfo arrow">
                <li><a href="{{ route('user-info') }}"><span class="pull-left">Профиль</span></a></li>
                @if(Auth::user()->role == 'user')
                <li class="divider">Курсы</li>
                <li><a href="#"><span class="pull-left">Бесплатные</span> <i class="pull-right fa fa-line-chart"></i></a></li>
                <li><a href="#"><span class="pull-left">Платные</span> <i class="pull-right fa fa-list-alt"></i></a></li>
                @endif
                <li class="divider"></li>
                <li>
