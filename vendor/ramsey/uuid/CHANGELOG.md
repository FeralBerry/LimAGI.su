...
* Add support for version 6 UUIDs, as defined by <https://gh.peabody.io/uuidv6/>,
...
* Add a `Type\TypeInterface` that each of the ramsey/uuid types implements.
* Support version 6 UUIDs; see <https://gh.peabody.io/uuidv6/>.
...
[comb sequential uuids]: https://www.informit.com/articles/article.aspx?p=25862&seqNum=7
...
[pecl libsodium extension]: https://pecl.php.net/package/libsodium
[ircmaxell/random-lib]: https://github.com/ircmaxell/RandomLib
[doctrine field type]: https://doctrine-dbal.readthedocs.org/en/latest/reference/types.html
